...
On the 21st April 2026, [OpenAI released ChatGPT Images 2](https://openai.com/index/introducing-chatgpt-images-2-0/), a new image generation model for ChatGPT. Unlike the old model, which regularly garbled text, the new model is much better at producing text and following instructions. 
...
I first asked ChatGPT Instant several times about the quest in separate conversations, and confirmed that it always gives plausible incorrect answers when I did not ask for a web search, and always gave correct answers when I did. Then, [in a new conversation in Instant mode, I gave this prompt](https://chatgpt.com/share/69f245a8-b63c-83eb-8968-d581d5b9ac16):
...
Then, [I tried again in Thinking mode, with the identical query](https://chatgpt.com/share/69f2473a-699c-83eb-9f45-3d4f9ac29883) that requests a web search:
...
[I had ChatGPT generate some Python code to create an image](https://chatgpt.com/share/69f235e9-fd94-83eb-9f87-6def856d9b0f):
...
I checked if ChatGPT could tell what the code would do, just by inspecting it. [It was broadly accurate](https://chatgpt.com/share/69f2361b-0220-83eb-ba00-37eaba33cd70):
...
I then asked a new instance of ChatGPT to create an infographic by running the pasted-in Python source code. I tried [in Instant mode](https://chatgpt.com/share/69f23644-6338-83eb-83af-524cca7acfa1) and [Thinking mode](https://chatgpt.com/share/69f23664-8b80-83eb-9db2-e3dfdfa5aeb8).
...
So, just as in Instant mode, ChatGPT Images will silently ignore instructions to search the web, similarly it will silently ignore instructions to run code, but tries to obscure that by guessing at what the code would produce. A whole range of graphics that depend on the output of algorithms cannot be produced in Instant mode, only in Thinking mode.
...
So, in Thinking mode, [I gave this prompt](https://chatgpt.com/share/69f2355e-87a8-83eb-b82e-9084e4aff1d9):
...
Perhaps I need to be more explicit, and make sure I get more accurate information into the context. [In a fresh chat (with Thinking mode)](https://chatgpt.com/share/69f23523-11e8-83eb-a69a-d71e62180d14):
...
[Third time lucky](https://chatgpt.com/share/69f23523-11e8-83eb-a69a-d71e62180d14): 
...
Next, I tried a multi-stage process where [I asked ChatGPT to find good data sources about solar power, to extract the data from them, and to create an infographic with graphs from them](https://chatgpt.com/share/69f24953-fb18-83eb-89e4-7df1989f6867). I made sure to get the relevant data into ChatGPT's context, I manually checked it against the sources, and went through a few iterations of what to display. This is the result:
